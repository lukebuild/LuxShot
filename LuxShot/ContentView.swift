...
struct ContentView: View {
    ...
    @State private var isHoveringAutoCopy: Bool = false
    ...
    // CSS Colors
    let bgWarm = Color(red: 253/255, green: 251/255, blue: 247/255) // #FDFBF7
    let textMain = Color(red: 51/255, green: 51/255, blue: 51/255) // #333333
    let textMuted = Color(red: 134/255, green: 134/255, blue: 139/255) // #86868B
    let accentAmber = Color(red: 245/255, green: 158/255, blue: 11/255) // #F59E0B
    let accentAmberHover = Color(red: 251/255, green: 191/255, blue: 36/255) // #FBBF24 (amber-400)
    ...
    var mainInterface: some View {
        ...
        HStack(spacing: 0) {
            ...
            VStack(spacing: 0) {
                ...
                ZStack {
                    ...
                    Button(action: {
                        store.performScan(autoCopy: autoCopy, showMainWindow: true)
                    }) {
                        ZStack {
        ...
        .overlay(alignment: .top) {
            // MARK: - ABSOLUTE HEADER OVERLAY (VS Code Style)
            ZStack {
                // Background with material effect
                Color.white.opacity(0.5)
                    .background(.ultraThinMaterial)
                
                // Layer 1: Absolute Centered Title
                Text("LuxShot")
                ...
                HStack(spacing: 0) {
                    ...
                    // Right: Compact toggle switches
                    HStack(spacing: 10) {
                        miniSwitch("Links", isOn: $store.autoOpenLinks)
                        miniSwitch("Breaks", isOn: $store.keepLineBreaks)
                        miniSwitch("Copy", isOn: $autoCopy)
                    }
                    .padding(.trailing, 16)
                }
                
                // Bottom Hairline for Header
                VStack {
                    Spacer()
                    Rectangle()
                        .fill(borderColor)
