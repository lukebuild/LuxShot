...
struct MenuBarView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            HStack(spacing: 8) {
                Spacer()
                miniSwitch("Open Links", isOn: $store.autoOpenLinks)
                miniSwitch("Line Breaks", isOn: $store.keepLineBreaks)
                miniSwitch("Auto Copy", isOn: $store.autoCopy)
                Spacer()
            }
    ...
    // Matched style from ContentView
        ...
        HStack(spacing: 6) {
            ...
            ZStack {
                ...
                Circle()
                    ...
                    .offset(x: isOn.wrappedValue ? 5.5 : -5.5)
